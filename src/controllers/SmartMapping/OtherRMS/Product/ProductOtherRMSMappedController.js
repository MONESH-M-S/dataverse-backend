...
const fetchProductOtherRMSMapping = async (req, res, next) => {
    try {
        ...
        const result = await ProductOtherRMSModel.findAll({
            limit,
            offset,
            where: whereClause,
            order: orderClause
...
const fetchOtherRMSProductMappedCount = async (req, res, next) => {
    try {
        const {
            Search,
            Filename,
        ...
        const result = await ProductOtherRMSModel.count({
            limit,
            offset,
            where: whereClause,
            order: orderClause
...
const downloadOtherRMSProductExcel = async (req, res, next) => {
    try {
        ...
        table.model = ProductOtherRMSModel;
