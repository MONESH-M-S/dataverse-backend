  ...
  try {
    ...
    switch (confidenceLevel) {
      ...
      case LOW:
        ...
        table.data =
          await sequelize.query(`select Externaldesc, Short, Tag, Filename, Hiernum, Hiername, Hierlevelnum, Parenttag, Company, Brand, Flag, Productname, Categoryname, Marketname, Corporatebrandname,
