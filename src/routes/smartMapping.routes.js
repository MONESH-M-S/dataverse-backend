...
//POS Fact details
router.get("/fact/pos/:id/:confidence", auth, fetchMappingFactPOSDetails);
router.get(
  "/fact/pos/:id/:confidence/count",
  auth,
  fetchMappingFactPOSDetailsPagination
);
...
router.get("/pos/:id/download/fact", auth, downloadPosFactExcelFile);
