...
} = require("../../controllers/SmartMapping/Nielsen/Product/ProductMappingController");
const {
  fetchProductUnprocessed,
  fetchProductUnprocessedPagination,
  downloadProductUnproccessed,
} = require("../../controllers/SmartMapping/Nielsen/Product/ProductUnprocessedController");

const {
  fetchProductPOSMapping,
  fetchProductPOSMappingPagination,
  downloadProductPOSMapping,
} = require("../../controllers/SmartMapping/POS/Product/ProductMappingPOSController");
const {
  fetchProductPOSUnprocessed,
  fetchProductPOSUnprocessedPagination,
  downloadProductPOSUnprocessed,
} = require("../../controllers/SmartMapping/POS/Product/ProductUnprocessedPOSController");

const {
  fetchOtherRMSProductMappedCount,
  fetchProductOtherRMSMapping,
  downloadOtherRMSProductExcel,
} = require("../../controllers/SmartMapping/OtherRMS/Product/ProductOtherRMSMappedController");
const {
  fetchProductOtherRMSUnprocessed,
  fetchProductOtherRMSUnprocessedCount,
  downloadProductOtherRMSUnprocessed,
} = require("../../controllers/SmartMapping/OtherRMS/Product/ProductOtherRMSUnprocessedController");

const {
  ProductUAOLMapping,
  ProductUAOLMappingCount,
  downloadUAOLProductMapping,
} = require("../../controllers/SmartMapping/Nielsen/Product/UAOL/ProductUAOLMappedController");
const {
  ProductUAOLUnprocessed,
  ProductUAOLUnprocessedCount,
  downloadUAOLProductUnproccessed,
} = require("../../controllers/SmartMapping/Nielsen/Product/UAOL/ProductUAOLUnprocessedController");
